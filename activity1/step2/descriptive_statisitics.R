...
ggplot(data, aes(salary_in_usd)) +
  ...
  theme_classic()
ggsave("activity1/step2/img/salary_histogram.pdf")

ggplot(data, aes(sqrt(salary_in_usd))) +
  geom_histogram(bins = 20) +
  labs(x = "sqrt(Salary in USD)", y = "Count") +
  theme_classic()
ggsave("activity1/step2/img/salary_histogram_sqrt.pdf")
...
ggplot(data, aes(sample = salary_in_usd)) +
  ...
  theme_classic()
ggsave("activity1/step2/img/salary_qq.pdf")
...
ggplot(data, aes(sample = sqrt(salary_in_usd))) +
  ...
  theme_classic()
ggsave("activity1/step2/img/salary_sqrt_qq.pdf")
...
cat("skewness raw :", skewness(data$salary_in_usd), "\n")
cat("skewness sqrt:", skewness(sqrt(data$salary_in_usd)), "\n")
...
ggplot(data, aes(salary_in_usd, experience_level)) +
  ...
  theme_classic()
ggsave("activity1/step2/img/salary_by_exp.pdf")
...
ggplot(data, aes(salary_in_usd, employment_type)) +
  ...
  theme_classic()
ggsave("activity1/step2/img/salary_by_employment.pdf")
...
ggplot(data, aes(salary_in_usd, as.factor(work_year))) +
  ...
  theme_classic()
ggsave("activity1/step2/img/salary_by_work_year.pdf")

# An increase in 2022, its mean salary is different from those in 2021 and 2020

print(table(data$remote_ratio))
ggplot(data, aes(salary_in_usd, as.factor(remote_ratio))) +
  geom_boxplot() +
  labs(x = "Salary in USD", y = "Remote work ratio (%)") +
  theme_classic()
ggsave("activity1/step2/img/salary_by_remote_ratio.pdf")
...
ggplot(data, aes(salary_in_usd, employee_residence)) +
  ...
  theme_classic()
ggsave("activity1/step2/img/salary_by_employee_residence.pdf")
...
ggplot(data, aes(salary_in_usd, company_location)) +
  ...
  theme_classic()
ggsave("activity1/step2/img/salary_by_company_location.pdf")
...
ggplot(data, aes(salary_in_usd, company_size)) +
  ...
  theme_classic()
ggsave("activity1/step2/img/salary_by_company_size.pdf")
...
ggplot(data, aes(salary_in_usd, leadership)) +
  ...
  theme_classic()
ggsave("activity1/step2/img/salary_by_leadership_role.pdf")
...
ggplot(data, aes(salary_in_usd, role)) +
  ...
  theme_classic()
ggsave("activity1/step2/img/salary_by_role.pdf")
