...
cat("   - Company Location: Working in the US significantly increases the odds of falling within the top 25% salary range\n")

# 5. Actionable Recommendations ------------------------------------------------
cat("--- 7.3 ACTIONABLE RECOMMENDATIONS ---\n\n")
cat("1. Suggestion in working condition")
cat("Working in the US should be preferred for increased salary. The specialized tracks should be focused: Engineering or Research branch, instead of Analyst")
cat("Being at leadership is a great boost in income.")


cat("2. Future analysis\n")
cat("Use other financial statistic: relative living cost, purchasing power parity, etc")
cat("To correctly evaluate the cost of living and thus income")
cat("More quantitivative variables should be collected for more accurate regression based prediction, since the current dataset is categorical variables only, affecting the ability for a regression model to fit the observation and thus their prediction ability")
