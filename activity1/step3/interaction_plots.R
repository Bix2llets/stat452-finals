...
draw_interaction(x = experience_level, line = employment_type, response = salary_in_usd)
...
draw_interaction(x = employment_type, line = company_location, response = salary_in_usd)
...
draw_interaction(x = leadership, line = employment_type, response = salary_in_usd)
draw_interaction(x = role, line = employment_type, response = salary_in_usd)
draw_interaction(x = role, line = company_location, response = salary_in_usd)
draw_interaction(x = remote_ratio, line = role, response = salary_in_usd)
draw_interaction(x = remote_ratio, line = employment_type, response = salary_in_usd)
draw_interaction(x = remote_ratio, line = company_location, response = salary_in_usd)
draw_interaction(x = remote_ratio, line = employment_type, response = salary_in_usd)
draw_interaction(x = remote_ratio, line = company_size, response = salary_in_usd)
draw_interaction(x = remote_ratio, line = experience_level, response = salary_in_usd)

# The effect of work_year
draw_interaction(x = work_year, line = experience_level, response = salary_in_usd)
draw_interaction(x = work_year, line = employment_type, response = salary_in_usd)
